...
const CREDENTIALS_PATH = path.join(process.cwd(), 'src/integrations/google-drive/client_secret.json');

const SCOPES = ['https://www.googleapis.com/auth/drive'];
const KEY_FILE = path.join(process.cwd(), 'src/integrations/google-drive/client_secret.json');
